namespace VidzyCodeFirst.Migrations
{
    ...
    public partial class ChangeVideoToOneGenreOnly : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("INSERT INTO _VideoGenres (Video_Id, Genre_Id) SELECT Video_Id, Genre_Id FROM VideoGenres");
        ...
        public override void Down()
        {
            ...
            Sql("INSERT INTO VideoGenres (Video_Id, Genre_Id) SELECT Video_Id, Genre_Id FROM _VideoGenres");
